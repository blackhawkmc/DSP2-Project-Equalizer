...
{   
    ...
    while(1)
    {
    	...
    	for(i = 0; i < AUDIO_IO_SIZE; i++)
        {
    		...
    		/*output1_Dirac[i] = shelvingLP(Dirac[i],shCoeffL,xHistoryL,yHistoryL,K_d);
    		output2_Dirac[i] = shelvingPeek(Dirac[i],shPeekCoeffPL,xHistoryPL,yHistoryPL,K_d);
    		output3_Dirac[i] = shelvingPeek(Dirac[i],shPeekCoeffPH,xHistoryPH,yHistoryPH,K_d);
            output4_Dirac[i] = shelvingHP(Dirac[i],shCoeffH,xHistoryH,yHistoryH,K_d);*/
